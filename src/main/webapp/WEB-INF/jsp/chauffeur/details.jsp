...
<div style="margin-bottom: 20px;">
    <nav class="breadcrumb">
        ...
        <span class="breadcrumb-separator"><i class="fas fa-chevron-right"></i></span>
        <span class="breadcrumb-item active">Détails du Chauffeur</span>
    </nav>
</div>

<div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
    <h2 style="font-size: 24px; font-weight: 700; color: #1f2937;">
        <i class="fas fa-info-circle"></i> ${chauffeur.nom} ${chauffeur.prenom}
    </h2>
    <div style="display: flex; gap: 10px;">
        <a href="<c:url value='/chauffeur/edit/${chauffeur.idChauffeur}'/>" class="btn-primary" style="text-decoration: none; display: inline-flex; align-items: center;">
...
<div class="form-container">
    <fieldset style="border: none; padding: 0; margin-bottom: 30px;">
        ...
        <div class="form-row">
            <div class="form-group form-group-row">
                ...
                <p style="margin: 0; padding: 12px 0; color: #1f2937;">${chauffeur.nom}</p>
            </div>

            <div class="form-group form-group-row">
                <label class="form-label" style="font-weight: 700;">Prénom</label>
                <p style="margin: 0; padding: 12px 0; color: #1f2937;">${chauffeur.prenom}</p>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <p style="margin: 0; padding: 12px 0; color: #1f2937;">
                <c:choose>
                    <c:when test="${chauffeur.telephone != null && !chauffeur.telephone.isEmpty()}">
                        ${chauffeur.telephone}
                    </c:when>
                    <c:otherwise>
    ...
    <div class="form-actions">
        <a href="<c:url value='/chauffeur/delete/${chauffeur.idChauffeur}'/>" class="btn-danger" style="text-decoration: none; display: inline-flex; align-items: center;" onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce chauffeur ?');">
